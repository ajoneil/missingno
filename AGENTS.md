...
- **Frontend debugger detail lives in `crates/missingno/AGENTS.md`**: the pane system and its registry seam, the frontend verification recipe, debug sidecars (`.sym`/`.cdl`), and off-chip peripherals (printer, RTC saves, softpatching).
