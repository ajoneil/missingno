...
use missingno_test_support::roundtrip::{assert_replays_deterministically, record_scripted};
...
fn cgb_recording_replays_deterministically() {
    ...
    assert_replays_deterministically(&recording, &mut cgb_console(rom), 16);
}
