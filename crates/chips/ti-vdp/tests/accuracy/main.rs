...
// once, on the NTSC body (262 lines); PAL is the ColecoVision core's.
...
mod harness {
    ...
    vdp_screenshot!(calibration, "harness/calibration.sg");
}
...
mod timing {
    ...
    vdp_test!(c_instant, "timing/c-instant.sg");
    vdp_test!(c_instant_x, "timing/c-instant-x.sg");
    ...
    vdp_test!(term_cadence, "timing/term-cadence.sg");
    vdp_test!(text_burst, "timing/text-burst.sg");
    vdp_test!(turn_on_66, "timing/turn-on-66.sg");
