...
pub fn view(app: &App) -> Element<'_, app::Message> {
    ...
    match &app.screen {
        ...
        app::Screen::HomebrewBrowser { .. } => {
            row![
                ...
                .on_press(app::Message::OpenUrl("https://hh.gbdev.io".to_string())),
                trailing(),
            ]
        }
        ...
        // own headers and never render through this bar.
        _ => unreachable!(),
    }
    .spacing(xl())
    .padding(m())
...
fn trailing() -> Element<'static, app::Message> {
    let row = row![];
