...
wilbertpol_cgb_test!(
    misc_boot_regs_cgb,
    "mooneye-wilbertpol/misc/boot_regs-cgb.gb"
);
wilbertpol_cgb_test!(
    misc_bits_unused_hwio_c,
    "mooneye-wilbertpol/misc/bits/unused_hwio-C.gb"
);
wilbertpol_cgb_test!(
    misc_gpu_vblank_stat_intr_c,
    "mooneye-wilbertpol/misc/gpu/vblank_stat_intr-C.gb"
);
wilbertpol_cgb_test!(
    gpu_hblank_ly_scx_timing_c,
...
wilbertpol_cgb_test!(
    gpu_stat_write_if_c,
    "mooneye-wilbertpol/acceptance/gpu/stat_write_if-C.gb"
);
