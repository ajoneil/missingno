        ...
        },
        {
            ...
            "inputSchema": object(json!({
                ...
                "set": { "type": "object", "properties": {
                    ...
                    "kind": { "type": "string", "enum": ["Game", "Demo", "Demoscene", "Test", "Tool"],
                    ...
                    "links": { "type": "array",
                               ...
                               "items": { "type": "object", "properties": {
                                   ...
                                   "link_type": { "type": "string",
                                                  "enum": ["Wiki", "Manual", "Source", "Speedrun", "UnusedContent", "TechnicalReference", "Guide", "Community", "Store", "DownloadPage", "Download"],
                                   ...
                                   "languages": { "type": "array",
                                                  "items": { "type": "string", "enum": ["English", "French", "German", "Spanish", "Italian", "Portuguese", "Dutch", "Japanese", "Swedish"] },
                ...
                "set": { "type": "object", "properties": {
                    ...
                    "languages": { "type": "array", "items": { "type": "string",
                        "enum": ["English", "French", "German", "Spanish", "Italian",
                                 "Portuguese", "Dutch", "Japanese", "Swedish"] },
