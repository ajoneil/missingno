            ...
            "inputSchema": object(json!({
                ...
                "set": { "type": "object", "properties": {
                    ...
                    "links": { "type": "array",
                               ...
                               "items": { "type": "object", "properties": {
                                   ...
                                   "link_type": { "type": "string",
                                                  "enum": ["Wiki", "Manual", "Source", "Speedrun", "UnusedContent", "TechnicalReference", "Guide", "Community", "DownloadPage", "Download"],
                                                  "description": "DownloadPage = a page to obtain the ROM from (forum thread / download page, human-followed); Download = a direct fetchable ROM file URL (.zip/.bin/.a26). Use these for freeware games; Community for buy/store pages." },
                    ...
                    "cart_type": { "type": "string",
                                   "description": "VCS board override (first release), e.g. \"F6SC\" — playtests boot with it; change it if the game boots wrong. Empty string clears it back to auto-detect." },
                }},
            }), &["key", "set"]),
        },
        {
            ...
            "inputSchema": object(json!({
                ...
                "set": { "type": "object", "properties": {
                    ...
                    "controllers": { "type": "array", "items": { "type": "string",
                        "enum": ["Joystick", "Paddle", "Driving", "Keypad", "Trackball", "BoosterGrip", "KidVid", "MindLink"] },
